...
nodes=$(aisckeeper print nodes --cluster-name $cluster_name  --log-verbosity 0)
...
kubectl -n local logs -l app.kubernetes.io/part-of=aisc --tail -1 --prefix -c aisc > dump/kubectl_logs
