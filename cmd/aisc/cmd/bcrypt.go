...
the second one, which is expected to be a quoted bcrypt hash.`,
		Example: `
$> aisc bcrypt super$ecret
$2a$10$eZP5YuhJq2k8DFmj9UJGWOIjDtXu6NcAQMrz7Zj1bgIVBcHA3bU5u

$> aisc bcrypt --check super$ecret '$2a$10$eZP5YuhJq2k8DFmj9UJGWOIjDtXu6NcAQMrz7Zj1bgIVBcHA3bU5u'
OK: password hash matches provided plain text`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if isCheck {
				if len(args) != 2 {
					fmt.Println("Usage:", "aisc bcrypt", "--check", "your-plain-text-password", "'password-hash'")
					return nil
				}
