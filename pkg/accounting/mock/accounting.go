...
type Service struct {
	...
	prepareDebitFunc        func(peer  aisc.Address, price uint64) (accounting.Action, error)
	prepareCreditFunc       func(peer  aisc.Address, price uint64, originated bool) (accounting.Action, error)
	balanceFunc             func( aisc.Address) (*big.Int, error)
	shadowBalanceFunc       func( aisc.Address) (*big.Int, error)
	balancesFunc            func() (map[string]*big.Int, error)
	compensatedBalanceFunc  func( aisc.Address) (*big.Int, error)
	compensatedBalancesFunc func() (map[string]*big.Int, error)
	peerAccountingFunc      func() (map[string]accounting.PeerInfo, error)
	balanceSurplusFunc      func( aisc.Address) (*big.Int, error)
}
...
func WithPrepareDebitFunc(f func(peer  aisc.Address, price uint64) (accounting.Action, error)) Option {
...
// WithDebitFunc sets the mock Debit function
func WithPrepareCreditFunc(f func(peer  aisc.Address, price uint64, originated bool) (accounting.Action, error)) Option {
	return optionFunc(func(s *Service) {
...
func WithBalanceFunc(f func( aisc.Address) (*big.Int, error)) Option {
	return optionFunc(func(s *Service) {
		s.balanceFunc = f
	})
}
...
func WithCompensatedBalanceFunc(f func( aisc.Address) (*big.Int, error)) Option {
	return optionFunc(func(s *Service) {
...
func WithBalanceSurplusFunc(f func( aisc.Address) (*big.Int, error)) Option {
	return optionFunc(func(s *Service) {
...
func (s *Service) MakeCreditAction(peer  aisc.Address, price uint64) accounting.Action {
	return &creditAction{
		accounting: s,
...
func (s *Service) PrepareDebit(_ context.Context, peer  aisc.Address, price uint64) (accounting.Action, error) {
...
func (s *Service) PrepareCredit(_ context.Context, peer  aisc.Address, price uint64, originated bool) (accounting.Action, error) {
...
func (s *Service) Balance(peer  aisc.Address) (*big.Int, error) {
...
func (s *Service) ShadowBalance(peer  aisc.Address) (*big.Int, error) {
...
func (s *Service) CompensatedBalance(peer  aisc.Address) (*big.Int, error) {
...
func (s *Service) Connect(peer  aisc.Address, full bool) {

}

func (s *Service) Disconnect(peer  aisc.Address) {

}

func (s *Service) SurplusBalance(peer  aisc.Address) (*big.Int, error) {
	if s.balanceFunc != nil {
