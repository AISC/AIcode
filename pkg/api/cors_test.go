...
func TestCORSHeaders(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{
			name:           "no origin",
			allowedOrigins: []string{"https://gateway. aisc.org"},
			wantCORS:       false,
		},
		{
			name:           "single explicit",
			origin:         "https://gateway. aisc.org",
			allowedOrigins: []string{"https://gateway. aisc.org"},
			wantCORS:       true,
		},
		{
		...
		},
		{
			...
			origin:         "https://staging.gateway. aisc.org",
			allowedOrigins: []string{"https://gateway. aisc.org", "https://staging.gateway. aisc.org"},
			wantCORS:       true,
		},
		{
