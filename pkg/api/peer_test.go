...
func TestConnect(t *testing.T) {
	...
	aiscAddress, err := aisc.NewAddress(crypto.NewDefaultSigner(privateKey), underlama, overlay, 0, nil)
	if err != nil {
		t.Fatal(err)
	}
	...
	testServer, _, _, _ := newTestServer(t, testServerOptions{
		DebugAPI: true,
		P2P: mock.New(mock.WithConnectFunc(func(ctx context.Context, addr ma.Multiaddr) (*aisc.Address, error) {
...
func TestDisconnect(t *testing.T) {
	...
	address :=  aisc.MustParseHexAddress("ca1e9f3938cc1425c6061b96ad9eb93e134dfe8734ad490164ef20af9d1cf59c")
	unknownAddress :=  aisc.MustParseHexAddress("ca1e9f3938cc1425c6061b96ad9eb93e134dfe8734ad490164ef20af9d1cf59e")
	errorAddress :=  aisc.MustParseHexAddress("ca1e9f3938cc1425c6061b96ad9eb93e134dfe8734ad490164ef20af9d1cf59a")
	testErr := errors.New("test error")

	testServer, _, _, _ := newTestServer(t, testServerOptions{
		DebugAPI: true,
		P2P: mock.New(mock.WithDisconnectFunc(func(addr  aisc.Address, reason string) error {
...
func TestPeer(t *testing.T) {
	...
	overlay :=  aisc.MustParseHexAddress("ca1e9f3938cc1425c6061b96ad9eb93e134dfe8734ad490164ef20af9d1cf59c")
	testServer, _, _, _ := newTestServer(t, testServerOptions{
		DebugAPI: true,
