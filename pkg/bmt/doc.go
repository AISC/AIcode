...
//
// BMT hash is used as the chunk hash function in  aisc which in turn is the basis for the
// 128 branching  aisc hash used to represent files.
//
...
// as well as the hash size optimal for inclusion proofs in the merkle tree of the  aisc hash.
//
