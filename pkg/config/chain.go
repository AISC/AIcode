...
// TODO: consider adding  aiscAddress (also as a cmd param) to the ChainConfig and remove the postagecontract.LookupERC20Address function.
...
func GetByChainID(chainID int64) (ChainConfig, bool) {
	...
	default:
		return ChainConfig{
			...
			AiscTokenSymbol:  Testnet.AiscTokenSymbol,
			StakingABI:        abi.TestnetStakingABI,
			PostageStampABI:   abi.TestnetPostageStampABI,
			RedistributionABI: abi.TestnetRedistributionABI,
		}, false
