...
func (f *finder) At(ctx context.Context, at int64, after uint64) ( aisc.Chunk, feeds.Index, feeds.Index, error) {
...
func (f *finder) common(ctx context.Context, at int64, after uint64) (*epoch,  aisc.Chunk, error) {
...
func (f *finder) at(ctx context.Context, at uint64, e *epoch, ch  aisc.Chunk) ( aisc.Chunk, error) {
...
func (f *asyncFinder) get(ctx context.Context, at int64, e *epoch) ( aisc.Chunk, error) {
...
func (f *asyncFinder) At(ctx context.Context, at int64, after uint64) ( aisc.Chunk, feeds.Index, feeds.Index, error) {
...
// At looks up the version valid at time `at`
// after is a unix time hint of the latest known update
func (f *asyncFinder) asyncAt(ctx context.Context, at int64, _ uint64) ( aisc.Chunk, error) {
	c := make(chan *result)
