...
func TestChunkPipe(t *testing.T) {
	...
	dataWrites := [][]int{
		{ aisc.ChunkSize - 2},                         // short
		{ aisc.ChunkSize - 2, 4},                      // short, over
		{ aisc.ChunkSize - 2, 4,  aisc.ChunkSize - 6}, // short, over, short
		{ aisc.ChunkSize - 2, 4,  aisc.ChunkSize - 4}, // short, over, onononon
		{ aisc.ChunkSize, 2,  aisc.ChunkSize - 4},     // on, short, short
		{ aisc.ChunkSize, 2,  aisc.ChunkSize - 2},     // on, short, on
		{ aisc.ChunkSize, 2,  aisc.ChunkSize},         // on, short, over
		{ aisc.ChunkSize, 2,  aisc.ChunkSize - 2, 4},  // on, short, on, short
		{ aisc.ChunkSize,  aisc.ChunkSize},            // on, on
	}
