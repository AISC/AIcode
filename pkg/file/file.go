...
type Joiner interface {
	...
	IterateChunkAddresses( aisc.AddressIterFunc) error
...
// When EOF is received and splitting is done, the resulting Aisc Address is returned.
type Splitter interface {
	Split(ctx context.Context, dataIn io.ReadCloser, dataLength int64, toEncrypt bool) (addr  aisc.Address, err error)
}
