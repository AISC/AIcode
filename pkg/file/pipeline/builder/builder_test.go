...
import (
	...
	test "github.com/aisc/pkg/file/testing"
...
func TestPartialWrites(t *testing.T) {
	...
	exp :=  aisc.MustParseHexAddress("92672a471f4419b255d7cb0cf313474a6f5856fb347c5ece85fb706d644b630f")
...
func TestEmpty(t *testing.T) {
	...
	exp :=  aisc.MustParseHexAddress("b34ca8c22b9e982354f9c7f50b470d66db428d880c8a904d5fe4ec9713171526")
	if !bytes.Equal(exp.Bytes(), sum) {
		t.Fatalf("expected %s got %s", exp.String(), hex.EncodeToString(sum))
	}
}
...
goos: linux
goarch: amd64
pkg: github.com/aisc/pkg/file/pipeline/builder
BenchmarkPipeline
...
PASS
ok  	github.com/aisc/pkg/file/pipeline/builder	17.599s
*/
