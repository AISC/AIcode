...
var (
	...
	fileLengths     = []int{
		...
		65,                           // 5
		 ...
		 aisc.ChunkSize + 32,         // 8
		 aisc.ChunkSize + 63,         // 9
		 aisc.ChunkSize + 64,         // 10
		 aisc.ChunkSize * 2,          // 11
		 aisc.ChunkSize*2 + 32,       // 12
		 aisc.ChunkSize * 128,        // 13
		 aisc.ChunkSize*128 + 31,     // 14
		 aisc.ChunkSize*128 + 32,     // 15
		 aisc.ChunkSize*128 + 64,     // 16
		 aisc.ChunkSize * 129,        // 17
		 aisc.ChunkSize * 130,        // 18
		 aisc.ChunkSize * 128 * 128,  // 19
		 aisc.ChunkSize*128*128 + 32, // 20
	}
...
func GetVector(t *testing.T, idx int) ([]byte,  aisc.Address) {
	t.Helper()
	...
	return data,  aisc.MustParseHexAddress(fileExpectHashHex[idx])
}
