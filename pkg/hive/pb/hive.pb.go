...
type Peers struct {
	Peers []* aiscAddress `protobuf:"bytes,1,rep,name=peers,proto3" json:"peers,omitempty"`
}
...
func (m *Peers) GetPeers() []* aiscAddress {
	if m != nil {
		return m.Peers
	}
	return nil
...
func (m * aiscAddress) Reset()         { *m =  aiscAddress{} }
func (m * aiscAddress) String() string { return proto.CompactTextString(m) }
func (* aiscAddress) ProtoMessage()    {}
func (* aiscAddress) Descriptor() ([]byte, []int) {
	return fileDescriptor_d635d1ead41ba02c, []int{1}
}
func (m * aiscAddress) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m * aiscAddress) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ aiscAddress.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m * aiscAddress) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ aiscAddress.Merge(m, src)
}
func (m * aiscAddress) XXX_Size() int {
	return m.Size()
}
func (m * aiscAddress) XXX_DiscardUnknown() {
	xxx_messageInfo_ aiscAddress.DiscardUnknown(m)
}

var xxx_messageInfo_ aiscAddress proto.InternalMessageInfo

func (m * aiscAddress) GetUnderlay() []byte {
	if m != nil {
		return m.Underlay
	}
	return nil
...
func (m * aiscAddress) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m * aiscAddress) GetOverlay() []byte {
	if m != nil {
		return m.Overlay
	}
	return nil
...
func (m * aiscAddress) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func init() {
	...
	proto.RegisterType((* aiscAddress)(nil), "hive. aiscAddress")
}
...
func (m * aiscAddress) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m * aiscAddress) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m * aiscAddress) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Peers) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Peers = append(m.Peers, & aiscAddress{})
...
func (m * aiscAddress) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto:  aiscAddress: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto:  aiscAddress: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
