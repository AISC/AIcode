...
func TestPretty(t *testing.T) {
	...
	testCases := []struct {
		...
		exp: `"<panic: value method github.com/aisc/pkg/log.marshalerTest.MarshalLog called using nil *marshalerTest pointer>"`,
	}, {
		...
		exp: `"<panic: value method github.com/aisc/pkg/log.stringerTest.String called using nil *stringerTest pointer>"`,
	}, {
		...
		val: (*errorTest)(nil),
		exp: `"<panic: value method github.com/aisc/pkg/log.errorTest.Error called using nil *errorTest pointer>"`,
	}, {
