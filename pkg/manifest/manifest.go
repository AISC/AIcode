...
// collection representation in Aisc.
package manifest
...
type Interface interface {
	...
	Store(context.Context, ...StoreSizeFunc) ( aisc.Address, error)
	// IterateAddresses is used to iterate over chunks addresses for
	// the manifest.
	IterateAddresses(context.Context,  aisc.AddressIterFunc) error
}
...
func NewEntry(reference  aisc.Address, metadata map[string]string) Entry {
...
func (e *manifestEntry) Reference()  aisc.Address {
	return e.reference
}
