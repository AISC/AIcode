...
import (
	...
	"github.com/aisc/pkg/storage/cache"
...
func checkOverlay(storer storage.StateStorer, overlay  aisc.Address) error {

	var storedOverlay  aisc.Address
...
func setOverlay(s storage.StateStorer, overlay  aisc.Address, nonce []byte) error {
	return errors.Join(
