...
import (
	...
	"github.com/aisc/pkg/p2p/libp2p/internal/headers/pb"
...
func handleHeaders(ctx context.Context, headler p2p.HeadlerFunc, stream *stream, peerAddress  aisc.Address) error {
	w, r := protobuf.NewWriterAndReader(stream)
