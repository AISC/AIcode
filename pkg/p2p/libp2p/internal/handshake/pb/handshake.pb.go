...
type Ack struct {
	Address        * aiscAddress `protobuf:"bytes,1,opt,name=Address,proto3" json:"Address,omitempty"`
...
func (m *Ack) GetAddress() * aiscAddress {
	if m != nil {
		return m.Address
	}
	return nil
...
func init() {
	...
	proto.RegisterType((* aiscAddress)(nil), "handshake. aiscAddress")
}
