...
import (
	...
	postagestoreMock "github.com/aisc/pkg/postage/batchstore/mock"
	postageMock "github.com/aisc/pkg/postage/mock"
...
func TestCreateBatch(t *testing.T) {
	...
	aiscTokenAddress := common.HexToAddress("eeee")
		...
		contract := postagecontract.New(
			...
			transactionMock.New(
				transactionMock.WithSendFunc(func(ctx context.Context, request *transaction.TxRequest, boost int) (txHash common.Hash, err error) {
					if *request.To == aiscTokenAddress {
