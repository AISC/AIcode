...
type ValidStampFn func(chunk  aisc.Chunk) ( aisc.Chunk, error)
...
func ValidStamp(batchStore Storer) ValidStampFn {
	return func(chunk  aisc.Chunk) ( aisc.Chunk, error) {
		stamp := chunk.Stamp()
...
func (s *Stamp) Valid(chunkAddr  aisc.Address, ownerAddr []byte, depth, bucketDepth uint8, immutable bool) error {
...
func RecoverBatchOwner(chunkAddr  aisc.Address, stamp  aisc.Stamp) ([]byte, error) {
