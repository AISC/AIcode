...
import (
	...
	mockps "github.com/aisc/pkg/pullsync/mock"
	"github.com/aisc/pkg/spinlock"
	"github.com/aisc/pkg/statestore/mock"
	"github.com/aisc/pkg/storage"
	resMock "github.com/aisc/pkg/storer/mock"
	"github.com/aisc/pkg/ aisc"
	kadMock "github.com/aisc/pkg/topology/kademlia/mock"
...
func TestRadiusDecrease(t *testing.T) {
	...
	pullsync.ResetCalls( aisc.ZeroAddress)
...
func checkIntervals(t *testing.T, s storage.StateStorer, addr  aisc.Address, expInterval string, bin uint8) {
	t.Helper()
...
func waitCursorsCalled(t *testing.T, ps *mockps.PullSyncMock, addr  aisc.Address) {
	t.Helper()
...
func waitSync(t *testing.T, ps *mockps.PullSyncMock, addr  aisc.Address) {
	t.Helper()
...
func waitSyncStart(t *testing.T, ps *mockps.PullSyncMock, addr  aisc.Address, start uint64) {
	t.Helper()
...
func waitSyncCalledBins(t *testing.T, ps *mockps.PullSyncMock, addr  aisc.Address, bins ...uint8) {
	t.Helper()
