...
func TestResolve(t *testing.T) {
	...
	testAiscAddr :=  aisc.MustParseHexAddress("aaabbbcc")
	...
	testCases := []struct {
		...
		{
			desc: "resolve does not prefix address with / aisc",
			resolveFn: func(*goens.Registry, common.Address, string) (string, error) {
				return testAiscAddr.String(), nil
			},
			wantErr: resolver.ErrInvalidContentHash,
		},
		{
			...
			resolveFn: func(*goens.Registry, common.Address, string) (string, error) {
				return ens.AiscContentHashPrefix + testAiscAddr.String(), nil
			},
			wantErr: resolver.ErrInvalidContentHash,
		},
		{
