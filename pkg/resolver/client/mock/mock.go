...
type Client struct {
	isConnected    bool
	endpoint       string
	defaultAddress  aisc.Address
	resolveFn      func(string) ( aisc.Address, error)
}
...
func WitResolveAddress(addr  aisc.Address) Option {
	return func(cl *Client) {
...
func WithResolveFunc(fn func(string) ( aisc.Address, error)) Option {
	return func(cl *Client) {
		cl.resolveFn = fn
	}
}
...
func (cl *Client) Resolve(name string) ( aisc.Address, error) {
	if cl.resolveFn == nil {
