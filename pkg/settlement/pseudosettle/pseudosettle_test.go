...
import (
	...
	"github.com/aisc/pkg/settlement/pseudosettle/pb"
...
func (t *testObserver) setPeerDebt(peer  aisc.Address, debt *big.Int) {
...
func (t *testObserver) Reserve(ctx context.Context, peer  aisc.Address, amount uint64) error {
	return nil
}

func (t *testObserver) Release(peer  aisc.Address, amount uint64) {
}

var testRefreshRate = int64(10000)
var testRefreshRateLight = int64(1000)

func testCaseNotAccepted(t *testing.T, recorder *streamtest.Recorder, payerObserver, receiverObserver *testObserver, payer, recipient *pseudosettle.Service, peerID  aisc.Address, payerTime, recipientTime int64, recordsLength int, debtAmount, amount *big.Int, expectedError error) {
	t.Helper()
...
func testCaseAccepted(t *testing.T, recorder *streamtest.Recorder, payerObserver, receiverObserver *testObserver, payer, recipient *pseudosettle.Service, peerID  aisc.Address, payerTime, recipientTime int64, recordsLength, msgLength, recMsgLength int, debtAmount, amount, accepted, totalAmount *big.Int) {
	t.Helper()
...
func TestPayment(t *testing.T) {
	...
	peerID :=  aisc.MustParseHexAddress("9ee7add7")
