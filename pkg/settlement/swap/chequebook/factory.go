...
type Factory interface {
	...
	// Deploy deploys a new chequebook and returns once the transaction has aiscn submitted.
	...
	// VerifyChequebook checks that the supplied chequebook has aiscn deployed by this factory.
...
// VerifyChequebook checks that the supplied chequebook has aiscn deployed by a supported factory.
