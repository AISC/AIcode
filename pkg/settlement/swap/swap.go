...
type Interface interface {
	...
	LastSentCheque(peer  aisc.Address) (*chequebook.SignedCheque, error)
	...
	LastReceivedCheque(peer  aisc.Address) (*chequebook.SignedCheque, error)
	...
	CashCheque(ctx context.Context, peer  aisc.Address) (common.Hash, error)
	// CashoutStatus gets the status of the latest cashout transaction for the peers chequebook
	CashoutStatus(ctx context.Context, peer  aisc.Address) (*chequebook.CashoutStatus, error)
}
...
// LastSentCheque returns the last sent cheque for the peer
func (s *Service) LastSentCheque(peer  aisc.Address) (*chequebook.SignedCheque, error) {
...
// LastReceivedCheque returns the last received cheque for the peer
func (s *Service) LastReceivedCheque(peer  aisc.Address) (*chequebook.SignedCheque, error) {
...
func (*NoOpSwap) TotalSent(peer  aisc.Address) (totalSent *big.Int, err error) {
	return nil, postagecontract.ErrChainDisabled
}

// TotalReceived returns the total amount received from a peer
func (*NoOpSwap) TotalReceived(peer  aisc.Address) (totalSent *big.Int, err error) {
	return nil, postagecontract.ErrChainDisabled
}
...
func (*NoOpSwap) LastSentCheque(peer  aisc.Address) (*chequebook.SignedCheque, error) {
	return nil, postagecontract.ErrChainDisabled
}
...
// LastReceivedCheque returns the last received cheque for the peer
func (*NoOpSwap) LastReceivedCheque(peer  aisc.Address) (*chequebook.SignedCheque, error) {
	return nil, postagecontract.ErrChainDisabled
}
...
// CashCheque sends a cashing transaction for the last cheque of the peer
func (*NoOpSwap) CashCheque(ctx context.Context, peer  aisc.Address) (common.Hash, error) {
	return common.Hash{}, postagecontract.ErrChainDisabled
}

// CashoutStatus gets the status of the latest cashout transaction for the peers chequebook
func (*NoOpSwap) CashoutStatus(ctx context.Context, peer  aisc.Address) (*chequebook.CashoutStatus, error) {
	return nil, postagecontract.ErrChainDisabled
}
