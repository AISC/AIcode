...
import (
	...
	mockchequebook "github.com/aisc/pkg/settlement/swap/chequebook/mock"
	mockchequestore "github.com/aisc/pkg/settlement/swap/chequestore/mock"
	"github.com/aisc/pkg/settlement/swap/swapprotocol"
	mockstore "github.com/aisc/pkg/statestore/mock"
	"github.com/aisc/pkg/ aisc"
)

type swapProtocolMock struct {
	emitCheque func(context.Context,  aisc.Address, common.Address, *big.Int, swapprotocol.IssueFunc) (*big.Int, error)
}

func (m *swapProtocolMock) EmitCheque(ctx context.Context, peer  aisc.Address, beneficiary common.Address, value *big.Int, issueFunc swapprotocol.IssueFunc) (*big.Int, error) {
	if m.emitCheque != nil {
...
func (t *testObserver) PeerDebt(peer  aisc.Address) (*big.Int, error) {
	return nil, nil
}

func (t *testObserver) NotifyPaymentReceived(peer  aisc.Address, amount *big.Int) error {
...
func (t *testObserver) NotifyRefreshmentSent(peer  aisc.Address, attemptedAmount, amount *big.Int, timestamp int64, allegedInterval int64, receivedError error) {
}

func (t *testObserver) NotifyRefreshmentReceived(peer  aisc.Address, amount *big.Int, time int64) error {
	return nil
}

func (t *testObserver) NotifyPaymentSent(peer  aisc.Address, amount *big.Int, err error) {
...
func (t *testObserver) Connect(peer  aisc.Address, full bool) {

}

func (t *testObserver) Disconnect(peer  aisc.Address) {

}

type addressbookMock struct {
	migratePeer     func(oldPeer, newPeer  aisc.Address) error
	beneficiary     func(peer  aisc.Address) (beneficiary common.Address, known bool, err error)
	chequebook      func(peer  aisc.Address) (chequebookAddress common.Address, known bool, err error)
	beneficiaryPeer func(beneficiary common.Address) (peer  aisc.Address, known bool, err error)
	chequebookPeer  func(chequebook common.Address) (peer  aisc.Address, known bool, err error)
	putBeneficiary  func(peer  aisc.Address, beneficiary common.Address) error
	putChequebook   func(peer  aisc.Address, chequebook common.Address) error
	addDeductionFor func(peer  aisc.Address) error
	addDeductionBy  func(peer  aisc.Address) error
	getDeductionFor func(peer  aisc.Address) (bool, error)
	getDeductionBy  func(peer  aisc.Address) (bool, error)
}

func (m *addressbookMock) MigratePeer(oldPeer, newPeer  aisc.Address) error {
	return m.migratePeer(oldPeer, newPeer)
}
func (m *addressbookMock) Beneficiary(peer  aisc.Address) (beneficiary common.Address, known bool, err error) {
	return m.beneficiary(peer)
}
func (m *addressbookMock) Chequebook(peer  aisc.Address) (chequebookAddress common.Address, known bool, err error) {
	return m.chequebook(peer)
}
func (m *addressbookMock) BeneficiaryPeer(beneficiary common.Address) (peer  aisc.Address, known bool, err error) {
	return m.beneficiaryPeer(beneficiary)
}
func (m *addressbookMock) ChequebookPeer(chequebook common.Address) (peer  aisc.Address, known bool, err error) {
	return m.chequebookPeer(chequebook)
}
func (m *addressbookMock) PutBeneficiary(peer  aisc.Address, beneficiary common.Address) error {
	return m.putBeneficiary(peer, beneficiary)
}
func (m *addressbookMock) PutChequebook(peer  aisc.Address, chequebook common.Address) error {
	return m.putChequebook(peer, chequebook)
}
func (m *addressbookMock) AddDeductionFor(peer  aisc.Address) error {
	return m.addDeductionFor(peer)
}
func (m *addressbookMock) AddDeductionBy(peer  aisc.Address) error {
	return m.addDeductionBy(peer)
}
func (m *addressbookMock) GetDeductionFor(peer  aisc.Address) (bool, error) {
	return m.getDeductionFor(peer)
}
func (m *addressbookMock) GetDeductionBy(peer  aisc.Address) (bool, error) {
...
func TestReceiveCheque(t *testing.T) {
	...
	peer :=  aisc.MustParseHexAddress("abcd")
	...
	addressbook := &addressbookMock{
		chequebook: func(p  aisc.Address) (common.Address, bool, error) {
			if !peer.Equal(p) {
				t.Fatal("querying chequebook for wrong peer")
			}
			return chequebookAddress, true, nil
		},
		putChequebook: func(p  aisc.Address, chequebook common.Address) (err error) {
			if !peer.Equal(p) {
		...
		addDeductionFor: func(p  aisc.Address) error {
...
func TestPay(t *testing.T) {
	...
	networkID := uint64(1)
	addressbook := &addressbookMock{
		beneficiary: func(p  aisc.Address) (common.Address, bool, error) {
			if !peer.Equal(p) {
	...
	swap := swap.New(
		&swapProtocolMock{
			emitCheque: func(ctx context.Context, p  aisc.Address, b common.Address, a *big.Int, issueFunc swapprotocol.IssueFunc) (*big.Int, error) {
				if !peer.Equal(p) {
...
func TestPayIssueError(t *testing.T) {
	...
	swap := swap.New(
		&swapProtocolMock{
			emitCheque: func(c context.Context, a1  aisc.Address, a2 common.Address, i *big.Int, issueFunc swapprotocol.IssueFunc) (*big.Int, error) {
				return nil, errReject
			},
		},
		logger,
...
func TestHandshake(t *testing.T) {
	...
	swapService := swap.New(
		...
		&addressbookMock{
			...
			beneficiaryPeer: func(common.Address) (peer  aisc.Address, known bool, err error) {
				return peer, true, nil
			},
			migratePeer: func(oldPeer, newPeer  aisc.Address) error {
				return nil
			},
			putBeneficiary: func(p  aisc.Address, b common.Address) error {
				putCalled = true
				return nil
			},
		},
...
func TestHandshakeNewPeer(t *testing.T) {
	...
	swapService := swap.New(
		...
		&addressbookMock{
			...
			beneficiaryPeer: func(beneficiary common.Address) ( aisc.Address, bool, error) {
				return peer, true, nil
			},
			migratePeer: func(oldPeer, newPeer  aisc.Address) error {
				return nil
...
func TestMigratePeer(t *testing.T) {
	...
	swapService := swap.New(
		...
		&addressbookMock{
			beneficiaryPeer: func(beneficiary common.Address) ( aisc.Address, bool, error) {
				return  aisc.MustParseHexAddress("00112233"), true, nil
			},
			migratePeer: func(oldPeer, newPeer  aisc.Address) error {
				return nil
			},
...
func TestStateStoreKeys(t *testing.T) {
	...
	address := common.HexToAddress("0xabcd")
	 aiscAddress :=  aisc.MustParseHexAddress("deff")

	expected := "swap_chequebook_peer_deff"
	if swap.PeerKey( aiscAddress) != expected {
		t.Fatalf("wrong peer key. wanted %s, got %s", expected, swap.PeerKey( aiscAddress))
	}
	...
	if swap.PeerBeneficiaryKey( aiscAddress) != expected {
		t.Fatalf("wrong peer beneficiary key. wanted %s, got %s", expected, swap.PeerBeneficiaryKey( aiscAddress))
	}
	...
	if swap.PeerDeductedByKey( aiscAddress) != expected {
		t.Fatalf("wrong peer deducted by key. wanted %s, got %s", expected, swap.PeerDeductedByKey( aiscAddress))
	}

	expected = "swap_deducted_for_peer_deff"
	if swap.PeerDeductedForKey( aiscAddress) != expected {
		t.Fatalf("wrong peer deducted for key. wanted %s, got %s", expected, swap.PeerDeductedForKey( aiscAddress))
	}
}
