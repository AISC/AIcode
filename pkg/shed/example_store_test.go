...
import (
	...
	shed2 "github.com/aisc/pkg/shed"
	"github.com/aisc/pkg/storage"
	"github.com/aisc/pkg/storage/testing"
...
func (s *Store) Put(_ context.Context, ch  aisc.Chunk) (err error) {
...
// are changed.
func (s *Store) Get(_ context.Context, addr  aisc.Address) (c  aisc.Chunk, err error) {
	...
	// Return the chunk.
	return  aisc.NewChunk( aisc.NewAddress(item.Address), item.Data), nil
}
