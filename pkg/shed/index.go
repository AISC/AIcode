...
// Item holds fields relevant to Aisc Chunk data and metadata.
// All information required for  aisc storage and operations
// on that storage must be defined here.
// This structure is logically connected to  aisc storage,
