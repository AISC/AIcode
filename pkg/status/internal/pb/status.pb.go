...
type Snapshot struct {
	...
	AiscMode                 string  `protobuf:"bytes,6,opt,name=AiscMode,proto3" json:"AiscMode,omitempty"`
...
func (m *Snapshot) GetAiscMode() string {
	if m != nil {
		return m.AiscMode
	}
	return ""
...
func (m *Snapshot) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AiscMode) > 0 {
		i -= len(m.AiscMode)
		copy(dAtA[i:], m.AiscMode)
		i = encodeVarintStatus(dAtA, i, uint64(len(m.AiscMode)))
		i--
		dAtA[i] = 0x32
	}
...
func (m *Snapshot) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AiscMode", wireType)
			}
			...
			m.AiscMode = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 7:
			if wireType != 0 {
