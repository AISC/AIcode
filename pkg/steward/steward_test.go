...
import (
	...
	postagetesting "github.com/aisc/pkg/postage/mock"
...
func (c *counter) Put(ctx context.Context, ch  aisc.Chunk) (err error) {
	c.count.Add(1)
...
func (lr *localRetriever) RetrieveChunk(ctx context.Context, addr, sourceAddr  aisc.Address) (chunk  aisc.Chunk, err error) {
	lr.mu.Lock()
	defer lr.mu.Unlock()
