...
func (m txChunkStoreWithMetrics) Get(ctx context.Context, address  aisc.Address) ( aisc.Chunk, error) {
	dur := captureDuration(time.Now())
...
func (m txChunkStoreWithMetrics) Put(ctx context.Context, chunk  aisc.Chunk) error {
	dur := captureDuration(time.Now())
...
func (m txChunkStoreWithMetrics) Delete(ctx context.Context, address  aisc.Address) error {
	dur := captureDuration(time.Now())
...
func (m txChunkStoreWithMetrics) Has(ctx context.Context, address  aisc.Address) (bool, error) {
	dur := captureDuration(time.Now())
