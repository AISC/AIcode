...
func TestSocMine(t *testing.T) {
	...
	prefixhasher := func() hash.Hash { return  aisc.NewPrefixHasher(prefix) }
...
func makeChunks(t *testing.T, signer crypto.Signer, sampleSize int, filterSOCAddr func( aisc.Address) bool, filterTrAddr func( aisc.Address) (bool, error), trHasher func() hash.Hash) error {
	t.Helper()
	...
	// the main loop terminating after sampleSize SOCs have aiscn generated
	eg.Go(func() error {
		defer cancel()
