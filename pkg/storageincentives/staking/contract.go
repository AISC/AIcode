...
type contract struct {
	...
	aiscTokenAddress        common.Address
...
func New(
	...
	return &contract{
		...
		aiscTokenAddress:        aiscTokenAddress,
...
func (c *contract) getStake(ctx context.Context, overlay  aisc.Address) (*big.Int, error) {
