...
func emptyBinIDs() []uint64 {
	return make([]uint64,  aisc.MaxBins)
}

func testDebugInfo(t *testing.T, newStorer func() (*storer.DB,  aisc.Address, error)) {
	t.Helper()
...
func TestDebugInfo(t *testing.T) {
	...
	t.Run("inmem", func(t *testing.T) {
		...
		testDebugInfo(t, func() (*storer.DB,  aisc.Address, error) {
