...
func (m putterWithMetrics) Put(ctx context.Context, chunk  aisc.Chunk) error {
...
func (m getterWithMetrics) Get(ctx context.Context, address  aisc.Address) ( aisc.Chunk, error) {
	dur := captureDuration(time.Now())
