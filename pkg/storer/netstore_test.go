...
type testRetrieval struct {
	fn func( aisc.Address) ( aisc.Chunk, error)
}

func (t *testRetrieval) RetrieveChunk(_ context.Context, address  aisc.Address, _  aisc.Address) ( aisc.Chunk, error) {
	return t.fn(address)
}
...
func testNetStore(t *testing.T, newStorer func(r retrieval.Interface) (*storer.DB, error)) {
	...
	t.Run("download", func(t *testing.T) {
		...
		t.Run("with cache", func(t *testing.T) {
			...
			lstore, err := newStorer(&testRetrieval{fn: func(address  aisc.Address) ( aisc.Chunk, error) {
