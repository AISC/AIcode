...
import (
	...
	batchstore "github.com/aisc/pkg/postage/batchstore/mock"
	postagetesting "github.com/aisc/pkg/postage/testing"
	pullerMock "github.com/aisc/pkg/puller/mock"
...
func TestIndexCollision(t *testing.T) {
	...
	testF := func(t *testing.T, baseAddr  aisc.Address, storer *storer.DB) {
		t.Helper()
...
func TestUnreserveCap(t *testing.T) {
	...
	testF := func(t *testing.T, baseAddr  aisc.Address, bs *batchstore.BatchStore, storer *storer.DB) {
		t.Helper()
...
func checkSaved(t *testing.T, st *storer.DB, ch  aisc.Chunk, stampSaved, chunkStoreSaved bool) {
	t.Helper()
