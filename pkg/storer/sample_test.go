...
func TestReserveSampler(t *testing.T) {
	...
	randChunks := func(baseAddr  aisc.Address, timeVar uint64) [] aisc.Chunk {
		var chs [] aisc.Chunk
	...
	testF := func(t *testing.T, baseAddr  aisc.Address, st *storer.DB) {
		t.Helper()
	...
	t.Run("disk", func(t *testing.T) {
		...
		opts.ValidStamp = func(ch  aisc.Chunk) ( aisc.Chunk, error) { return ch, nil }
