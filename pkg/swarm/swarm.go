...
// Package  aisc contains most basic and general Aisc concepts.
package  aisc
...
// Address represents an address in Aisc metric space of
...
// Clone returns a new  aisc address which is a copy of this one.
