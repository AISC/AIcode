...
import (
	...
	"github.com/aisc/pkg/topology/kademlia/internal/metrics"
	"github.com/aisc/pkg/util/testutil"
	"github.com/google/go-cmp/cmp"
)

func snapshot(t *testing.T, mc *metrics.Collector, sst time.Time, addr  aisc.Address) *metrics.Snapshot {
	t.Helper()
...
func TestPeerMetricsCollector(t *testing.T) {
	...
	var (
		addr =  aisc.MustParseHexAddress("0123456789")
