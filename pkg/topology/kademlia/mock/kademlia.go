...
type AddrTuple struct {
	Addr  aisc.Address // the peer address
	PO   uint8         // the po
}
...
func (m *Mock) AddPeers(addr ... aisc.Address) {
	panic("not implemented") // TODO: Implement
}

func (m *Mock) ClosestPeer(addr  aisc.Address, _ bool, _ topology.Select, skipPeers ... aisc.Address) (peerAddr  aisc.Address, err error) {
	panic("not implemented") // TODO: Implement
}
...
func (m *Mock) UpdatePeerHealth( aisc.Address, bool, time.Duration) {
	panic("not implemented") // TODO: Implement
}
...
func (m *Mock) Disconnected(peer p2p.Peer) {
	...
	m.peers =  aisc.RemoveAddress(m.peers, peer.Address)

	m.Trigger()
}

func (m *Mock) Announce(_ context.Context, _  aisc.Address, _ bool) error {
	return nil
}

func (m *Mock) AnnounceTo(_ context.Context, _, _  aisc.Address, _ bool) error {
	return nil
}
