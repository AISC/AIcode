...
type Traverser interface {
	...
	Traverse(context.Context,  aisc.Address,  aisc.AddressIterFunc) error
}
...
func (s *service) Traverse(ctx context.Context, addr  aisc.Address, iterFn  aisc.AddressIterFunc) error {
	processBytes := func(ref  aisc.Address) error {
